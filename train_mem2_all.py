...
from datasets.mem2_all import mem2_allDataset
...
def main(args):
    ...
    # Setup the dataset
    train_dataset = mem2_allDataset(os.path.join(c.data_path, 'metadata_train.csv'),
    ...
    val_dataset = mem2_allDataset(os.path.join(c.data_path, 'metadata_val.csv'),
                                  os.path.join(c.data_path, 'wavs'),
                                  c.r,
                                  c.sample_rate,
                                  c.text_cleaner,
